...
utils.km.file.AuthPanel = function(instanceId) {
	this.instanceId = instanceId;
	this.ds = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
							url : '/utils/km/file/auth.jcp?',
							method : 'GET'
						}),
	...
	utils.km.file.AuthPanel.superclass.constructor.call(this, {
				region : 'east',
				collapsible : false,
				split : true,
				width : 400,
...
Ext.extend(utils.km.file.AuthPanel, Ext.Panel, {
