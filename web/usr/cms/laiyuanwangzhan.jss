...
usr.cms.laiyuanwangzhan=function(){
	

	Ext.apply(usr.cms.laiyuanwangzhan.prototype,{
		...
		var ds=new Ext.data.JsonStore({
					method: 'GET',
					url : '/usr/cms/laiyuanwangzhan.jcp',
					root : 'authArray',
...
var grid = new Ext.grid.GridPanel({
        ...
        columns:[
        	...
        	{header:"PV",width:50,dataIndex:"count",sortable: false},
