...
lib.grid.BufferView = Ext.extend(Ext.grid.GridView, {
	/**
	...
	initTemplates : function(){
		lib.grid.BufferView.superclass.initTemplates.call(this);
	...
	syncScroll: function(){
		lib.grid.BufferView.superclass.syncScroll.apply(this, arguments);
		this.update();
	},
    ...
    onRemove : function(ds, record, index, isUpdate){
        lib.grid.BufferView.superclass.onRemove.apply(this, arguments);
        if(isUpdate !== true){
            this.update();
        }
    },
    ...
    destroy : function(){
        ...
        lib.grid.BufferView.superclass.destroy.call(this);
    },

	layout: function(){
		lib.grid.BufferView.superclass.layout.call(this);
		this.update();
	}
});