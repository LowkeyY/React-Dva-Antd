...
ExternalItems.haiwaizhishigongxiang.FileAttBeforeInitSH = function(mySelfConfig, json, param, parentPanel) {
		...
		mySelfConfig.loadResult = mySelfConfig.loadResult.createInterceptor(
				function(result) {
					if(Ext.isObject(result.data)){
						...
						if(result.data.COUNTRY_ID.value){
							mySelfConfig.TypeClick(result.data.COUNTRY_ID.value,this);
						}
						/* 预览状态 隐藏无数据的列
	...
	mySelfConfig.buttons = json.buttonArray;
	var beforeRelations = {
/*		COUNTRY_ID : "REGION_ID",
	...
	*/};
	...
	mySelfConfig.TypeClick = function(classValue, form) {
		var type;
		if (!classValue) {
			classValue = this.form.findField('COUNTRY_ID').getValue();
			type = this.form.findField('ATT_1');
		} else {
			type = form.form.findField('ATT_1');
		}
		type.show();
		Ext.each(type.items.items, function(c) {
					var form = this.findParentByType("form");

					if (classValue == "ac886ab6-1cf8-4ede-bc2f-633083f0ed0a") {
						if (c.inputValue == "1" || c.inputValue == "3"
								|| c.inputValue == "2") {
							c.show();
						} else {
							c.hide();
					...
					} else if (classValue == "e1c54e40-8d7d-4d60-a0b1-73fac2308f23"
							|| classValue == "ae3345f7-a7c3-47ce-90e0-8aa7f4547228"
							|| classValue == "ad4886bb-aeec-4d81-98bd-a30f4a661743"
							|| classValue == "fc341da5-9d83-4ec9-9d92-ba615cecca7c"
							|| classValue == "45880cb3-5daf-44b6-b4dd-3161d9edb66a"
							|| classValue == "e49a4dd4-6f5f-432f-bf3c-b95285abc9c6"
					...
					} else if (classValue == "6d0c9c91-693e-4628-95cf-87d17bc9121e"
							|| classValue == "5be8a4f9-51c1-461d-8845-a3a8e56ef930") {
