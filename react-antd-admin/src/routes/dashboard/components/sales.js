...
function Sales ({ data }) {
  return (
    <div className={styles.sales}>
      <div className={styles.title}>招生与就业</div>
      <ResponsiveContainer minHeight={360}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" dataKey="就业人数" stroke={color.purple} strokeWidth={3} dot={{ fill: color.purple }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="助教人数" stroke={color.red} strokeWidth={3} dot={{ fill: color.red }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="招生人数" stroke={color.green} strokeWidth={3} dot={{ fill: color.green }} activeDot={{ r: 5, strokeWidth: 0 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
