Ext.namespace('lib.tagcloud');

/**
 * @class lib.tagcloud.TagCloud
...
lib.tagcloud.TagCloud = function(config){

	lib.tagcloud.TagCloud.superclass.constructor.call(this, config);
    ...
    this.addEvents({
         ...
         * @param {lib.tagcloud.TagCloud}     cloud This tag cloud
...
Ext.extend(lib.tagcloud.TagCloud, Ext.Component, {
	...
	refresh : function(){
		...
		for(var i=0; i < records.length; i++){
			...
			var child = this.list.createChild({
				...
				html:'<a href="#">'+records[i].data[this.displayField]+(this.displayWeight ? '' : '')+'</a>'
