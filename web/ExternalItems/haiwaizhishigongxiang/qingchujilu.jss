...
ExternalItems.haiwaizhishigongxiang.qingchujilu = function(btn, type) {
	...
	Ext.msg("confirm", "确定删除选择的记录?", function(answer) {
				if (answer == 'yes') {
					...
					Ext.Ajax.request({
					url : '/ExternalItems/haiwaizhishigongxiang/qingchujilu.jcp',
					method : 'POST',
					params : par,
					scope : this,
