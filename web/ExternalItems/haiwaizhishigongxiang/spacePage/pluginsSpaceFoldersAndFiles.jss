...
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsSpaceFoldersAndFiles = function() {
	this.id = "ExternalItems.haiwaizhishigongxiang.spacePage.pluginsSpaceFoldersAndFiles";
	this.init();
};
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsSpaceFoldersAndFiles.prototype = {
	...
	refresh : function() {
		...
		Ext.Ajax.request({
			url : "/ExternalItems/haiwaizhishigongxiang/spacePage/pluginsSpaceFoldersAndFiles.jcp",
			method : "POST",
			scope : this,
