(function () {
    ...
    paramRoles = [{'id': '20469', 'text': '办公厅用户'}, {'id': '20661', 'text': '省长'}, {'id': '21007', 'text': '厅级干部'}, {'id': '21006', 'text': '秘书长'}, {'id': '20657', 'text': '副省长'}] , 
    paramUsertypes = [{"text": "架构师", "id": 2}, {"text": "开发人员", "id": 5}, {"text": "定制人员", "id": 10}, {"text": "部门管理员", "id": 20}, {"text": "普通用户", "id": 100}];
    var userPageHtml =  
                        ...
                        '                        <div class="form-group">' +
                        '                            <div class="controls">' +
                        '                                <input type="text" class="form-control" name="zp" placeholder="照片">' +
                        '                            </div>' +
                        '                        </div>' +
                        '                    </div>' +
                        '                </div>' +
                        ...
                        '                        <div class="form-group">' +
                        '                            <div class="controls">' +
                        '                                <input type="password" class="form-control" name="confirm_passwd" placeholder="再次输入密码">' +
                        '                            </div>' +
                        '                        </div>' +
                        '                    </div>' +
                        '                </div>' +
                        ...
                        '                                    <div class="md-checkbox-inline">' +
                        '                                        <div class="md-checkbox has-success">' +
                        '                                            <input type="checkbox" id = "isMaster" name = "isMaster"  class="md-check">' +
                        '                                            <label for="isMaster">是否部门业务主管' +
                        '                                                <span></span>' +
                        '                                                <span class="check"></span>' +
                        '                                                <span class="box"></span>' +
                        '                                            </label>' +
    ...
    function panks(conf) {
        return '<div class="row" id="module_' + conf.id + '">' +
                ...
                '   </div>' +
                '</div>' + 
                panksToolsPage(conf, "create", "新建用户") +
                panksToolsPage(conf, "edit", "修改用户");
    }
    ...
    function panksLeft(conf) {
        return '<div class="profile-sidebar">' +
                ...
                '        </div>' +
                '        <div class="portlet-body">' +
                '            <div id="tree_' + conf.id + '" class="tree-demo">' +
                '            </div>' +
                '        </div>' +
                '    </div>' +
                '</div>';
