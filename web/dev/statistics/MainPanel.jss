(function(){
    ...
    function getDatas(moduleId){
        return '<div class="row" id="module_'+moduleId+'"> ' + 
                ...
                '				<div class="caption"><i class="fa fa-file-o"></i>统计分析</div> ' + 
                '				<div class="tools">' + 
                ...
                '						<li class="">' + 
                '							<a href="#'+moduleId+'_1" data-toggle="tab" aria-expanded="false">全站访问量</a>' + 
                '						</li>' + 
                '						<li class="active">' + 
                '							<a href="#'+moduleId+'_2" data-toggle="tab" aria-expanded="false">时段分布统计</a>' + 
                '						</li>' + 
                '						<li class="">' + 
                '							<a href="#'+moduleId+'_3" data-toggle="tab" aria-expanded="false">操作系统比例</a>' + 
                '						</li>' + 
                '						<li class="">' + 
                '							<a href="#'+moduleId+'_4" data-toggle="tab" aria-expanded="false">浏览器统计</a>' + 
                '						</li>' + 
                '						<li class="">' + 
                '							<a href="#'+moduleId+'_5" data-toggle="tab" aria-expanded="false">语言统计</a>' + 
                '						</li>' + 
                '						<li class="">' + 
                '							<a href="#'+moduleId+'_6" data-toggle="tab" aria-expanded="false">分辨率统计</a>' + 
                '						</li>' + 
                '					</ul>' + 
                '					<div class="tab-content">' + 
                '						<div class="tab-pane" id="'+moduleId+'_1">' + getRiQi(moduleId+'_1') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_2">' + getRiQi(moduleId+'_2') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_3">' + getRiQi(moduleId+'_3') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_4">' + getRiQi(moduleId+'_4') + 
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_5">' + getRiQi(moduleId+'_5') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_6">' + getRiQi(moduleId+'_6') + 
                '						</div>' + 
                '					</div>' + 
                '				</div>' + 
                '			</div>' + 
            ...
            appendHtml(getDatas(conf.id) , function(){
                ...
                $('#'+conf.id).on('click', 'li > a', function (el) {
                    ...
                    if(clickId && (selector = $(clickId))){
                        ...
                        } else if(clickId.endsWith("_5|_6")){
