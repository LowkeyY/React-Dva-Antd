...
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsSpaceFoldersAndFileCount = function() {
	this.id = "ExternalItems.haiwaizhishigongxiang.spacePage.pluginsSpaceFoldersAndFileCount";
	this.init();
};
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsSpaceFoldersAndFileCount.prototype = {
	...
	refresh : function() {
		...
		Ext.Ajax.request({
			url : "/ExternalItems/haiwaizhishigongxiang/spacePage/pluginsSpaceFoldersAndFileCount.jcp",
			method : "POST",
			scope : this,
