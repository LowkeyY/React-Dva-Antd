...
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsUserCountWeek = function() {
	this.id = "ExternalItems.haiwaizhishigongxiang.spacePage.pluginsUserCountWeek";
	this.init();
}
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsUserCountWeek.prototype = {
	...
	refresh : function(){
		...
		var chart = this.chart , mainPanel = this.mainPanel , data = this.data;
			...
			if(!mainPanel.el || !mainPanel.el.dom)
				return;
			Ext.Ajax.request({
					url : '/ExternalItems/haiwaizhishigongxiang/spacePage/getUserFileCount.jcp',
					method : 'POST',
					scope : this,
