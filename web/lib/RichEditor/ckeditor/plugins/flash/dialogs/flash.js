					...
					case o :
						...
						if (f || e && l === h["default"])
							...
							var p = CKEDITOR.dom.element.createFromHtml(
									"<cke:param></cke:param>", a.getDocument());
							p.setAttributes({
										name : h.name,
										value : l
									});
							1 > a.getChildCount() ? p.appendTo(a) : p
									.insertBefore(a.getFirst())
						}
						break;
					case i :
						if (!b)
				...
				if (this.fakeImage)
					e = this.objectNode, d = this.embedNode;
						...
						&& (e = CKEDITOR.dom.element.createFromHtml(
								"<cke:object></cke:object>", a.document), e
								.setAttributes({
									classid : "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000",
									codebase : "http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"
								})), i)
					d = CKEDITOR.dom.element.createFromHtml(
							"<cke:embed></cke:embed>", a.document), d
							.setAttributes({
			...
			contents : [{
				...
				elements : [{
					...
					children : [{
						...
						validate : CKEDITOR.dialog.validate
								.htmlLength(a.lang.common.invalidHtmlLength
										.replace("%1", a.lang.common.height)),
						setup : b,
						commit : c
					}, {
						type : "text",
				...
				elements : [{
							...
							requiredContent : "embed{cke-xyz}",
							validate : CKEDITOR.dialog.validate
									.inlineStyle(a.lang.common.invalidInlineStyle),
