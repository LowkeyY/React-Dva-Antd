...
lib.GroupHeaderGrid.GroupHeaderGrid = Ext.extend(Ext.util.Observable, {
    ...
    viewConfig: {
        ...
        renderHeaders: function(){
            ...
            for(var row = 0, rlen = rows.length; row < rlen; row++){
                ...
                for(var i = 0, gcol = 0, len = r.length; i < len; i++){
                    ...
                    var id = this.getColumnId(group.dataIndex ? cm.findColumnIndex(group.dataIndex) : gcol), gs = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getGroupStyle.call(this, group, gcol);
        ...
        onColumnWidthUpdated: function(){
            ...
            lib.GroupHeaderGrid.GroupHeaderGrid.prototype.updateGroupStyles.call(this);
        },
        ...
        afterRenderUI: function(){
            ...
            Ext.apply(this.columnDrop, lib.GroupHeaderGrid.GroupHeaderGrid.prototype.columnDropConfig);
            Ext.apply(this.splitZone, lib.GroupHeaderGrid.GroupHeaderGrid.prototype.splitZoneConfig);
        }
    },
    ...
    columnDropConfig: {
        ...
        positionIndicator: function(h, n, e){
            var data = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getDragDropData.call(this, h, n, e);
            if(data === false){
                return false;
            }
        ...
        onNodeDrop: function(n, dd, e, data){
            var h = data.header;
            if(h != n){
                var d = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getDragDropData.call(this, h, n, e);
                if(d === false){
                    return false;
                }
            ...
            if(row < rows.length){
                ...
                for(var i = 0, gcol = 0; i < cells.length; i++){
                    ...
                    if((typeof col != 'number') || (col >= gcol && col < gcol + group.colspan)){
                        var gs = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getGroupStyle.call(this, group, gcol);
    ...
    getDragDropData: function(h, n, e){
        ...
        var row = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getGroupRowIndex.call(this.view, h),
            oldGroup = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getGroupSpan.call(this.view, row, oldIndex),
            newGroup = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getGroupSpan.call(this.view, row, newIndex),
        ...
        var parentGroup = lib.GroupHeaderGrid.GroupHeaderGrid.prototype.getGroupSpan.call(this.view, row - 1, oldIndex);
