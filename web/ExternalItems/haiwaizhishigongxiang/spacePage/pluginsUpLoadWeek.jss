...
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsUploadWeek = function() {
	this.id = "ExternalItems.haiwaizhishigongxiang.spacePage.pluginsUploadWeek";
	this.init();
}
ExternalItems.haiwaizhishigongxiang.spacePage.pluginsUploadWeek.prototype = {
	...
	refresh : function(){
		...
		var chart = this.chart , mainPanel = this.mainPanel , data = this.data;
			...
			Ext.Ajax.request({
					url : '/ExternalItems/haiwaizhishigongxiang/spacePage/getUploadWeek.jcp',
					method : 'POST',
					scope : this,
