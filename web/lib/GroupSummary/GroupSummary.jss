 ...
 * http://www.extjs.com/license
 */
Ext.ns('lib.GroupSummary');

/**
 * @class lib.GroupSummary.GroupSummary
 * @extends Ext.util.Observable
 * A GridPanel plugin that enables dynamic column calculations and a dynamically
 * updated grouped summary row.
 */
lib.GroupSummary.GroupSummary = Ext.extend(Ext.util.Observable, {
    /**
...
summaryRenderer: function(v, params, data){
    ...
    constructor : function(config){
        ...
        lib.GroupSummary.GroupSummary.superclass.constructor.call(this);
    },
    init : function(grid){
        this.grid = grid;
    ...
    calculate : function(rs, cs){
        ...
        for(var j = 0, jlen = rs.length; j < jlen; j++){
            ...
            for(var i = 0, len = cs.length; i < len; i++){
                ...
                cf = cfg[i];
                if(cf.summaryType){
                    data[c.name] = lib.GroupSummary.GroupSummary.Calculations[cf.summaryType](data[c.name] || 0, r, c.name, data);
                }
            }
        }
        return data;
...
//backwards compat
Ext.grid.GroupSummary = lib.GroupSummary.GroupSummary;
...
lib.GroupSummary.GroupSummary.Calculations['totalCost'] = function(v, record, field){
...
lib.GroupSummary.GroupSummary.Calculations = {
...
Ext.grid.GroupSummary.Calculations = lib.GroupSummary.GroupSummary.Calculations;

/**
 * @class lib.GroupSummary.HybridSummary
 * @extends lib.GroupSummary.GroupSummary
 ...
 *
 */
lib.GroupSummary.HybridSummary = Ext.extend(lib.GroupSummary.GroupSummary, {
    /**
     * @private
     * @param {Object} rs
     * @param {Object} cs
    ...
    calculate : function(rs, cs){
        ...
        return gdata || lib.GroupSummary.HybridSummary.superclass.calculate.call(this, rs, cs);
    },
...
//backwards compat
Ext.grid.HybridSummary = lib.GroupSummary.HybridSummary;
