...
/*loadcss("ExternalItems.haiwaizhishigongxiang.css.video-js.min");
using("ExternalItems.haiwaizhishigongxiang.js.video.min");*/


ExternalItems.haiwaizhishigongxiang.FilePreviewWindow = function() {
