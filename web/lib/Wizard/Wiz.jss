Ext.namespace('lib.Wizard');
Ext.namespace('lib.Wizard.Wiz');
/**
 ...
 * A {@link lib.Wizard.Wiz}-component consists typically of a {@link lib.Wizard.Wiz.Header}
 * and window-buttons ({@link Ext.Button}) which are linked to the {@link lib.Wizard.Wiz.Card}s
 * which themself represent the forms the user has to fill out.
 *
 * In order to switch between the cards in the wizard, you need the {@link lib.Wizard.layout.CardLayout},
 ...
 */
lib.Wizard.Wiz = Ext.extend(Ext.Window, {
...
this.showLoadMask(true, 'validating');
    ...
    /**
     * @cfg {Array} cards A numeric array with the configured {@link lib.Wizard.Wiz.Card}s.
     ...
     */
    finishButtonText : '完成'.loc(),

    /**
     * @cfg {Object} headerConfig A config-object to use with {@link lib.Wizard.Wiz.Header}.
     ...
     * ({@link lib.Wizard.Wiz.Card}). The card-panel itself uses the custom
     * {@link lib.Wizard.layout.CardLayout}, which needs to be accessible by this class.
    ...
    /**
     * @param {Number} currentCard The current {@link lib.Wizard.Wiz.Card} displayed.
     * Defaults to -1.
     * @private
     */
    currentCard : -1,
    ...
    /**
     * @param {lib.Wizard.Wiz.Header} The header-panel of the wizard.
     * @private
     */
    headPanel : null,
    ...
    initComponent : function()
    {
        ...
        lib.Wizard.Wiz.superclass.initComponent.call(this);
    },
...
// -------- helper
    ...
    /**
     * Inits the listener for the various {@link lib.Wizard.Wiz.Card}s used
     * by this component.
     */
    initEvents : function()
    {
        lib.Wizard.Wiz.superclass.initEvents.call(this);
     ...
     * Be sure to have the custom {@link lib.Wizard.layout.CardLayout} available
    ...
    initPanels : function()
    {
        ...
        this.headPanel = new lib.Wizard.Wiz.Header(this.headerConfig);
...
// -------- listeners
     ...
     * card itself.
     *
     * @param {lib.Wizard.Wiz.Card} The card that triggered the event.
     ...
     *
     * @param {lib.Wizard.Wiz.Card} The card being shown.
     */
     ...
     * Switches to the previous displayed {@link lib.Wizard.Wiz.Card}.
     */
    ...
    /**
     * Listener for the next-button. Switches to the next {@link lib.Wizard.Wiz.Card}
     * if the 'beforehide'-method of it did not return false. The functionality
     * for this is implemented in {@link lib.Wizard.layout.CardLayout}, which is needed
     * as the layout for the card-panel of this component.
     */
    onNextClick : function()
    {
		var isValid=true;
        this.cards[this.currentCard].form.items.each(function(f){
            if(!f.isValid()){
                isValid =false;
            }
        });
...
lib.Wizard.Wiz.Header = Ext.extend(Ext.BoxComponent, {
    ...
    /**
     * @cfg {String} region The Region of this component. Since a {@link lib.Wizard.Wiz}
     ...
     * {@link lib.Wizard.Wiz.Card}
     * @type String
     */
    stepText : '第 {0} 步,共{1}步: {2}'.loc(),
...
// -------- helper
    /**
     * Gets called by  {@link lib.Wizard.Wiz#onCardShow()} and updates the header
     ...
     * the wizard
     * @param {String} title The title-property of the {@link lib.Wizard.Wiz.Card}
     *
     * @private
     */
...
// -------- listener
    ...
    {
        lib.Wizard.Wiz.Header.superclass.onRender.call(this, ct, position);
...
lib.Wizard.Wiz.Card = Ext.extend(Ext.FormPanel, {
    ...
    initComponent : function()
    {
        this.addEvents(
             ...
             * this instance of {@see lib.Wizard.Wiz.Card}. This is needed since a card layout usually
             ...
             *
             * @param {lib.Wizard.Wiz.Card} card The card that triggered the event
             */
            'beforecardhide'
        );


        lib.Wizard.Wiz.Card.superclass.initComponent.call(this);
...
// -------- overrides
    ...
    bindHandler : function()
    {
        ...
        lib.Wizard.Wiz.Card.superclass.bindHandler.call(this);
    },
    ...
    initEvents : function()
    {
        ...
        lib.Wizard.Wiz.Card.superclass.initEvents.call(this);
