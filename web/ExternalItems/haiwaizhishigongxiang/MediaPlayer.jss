...
/*
 * ExternalItems.haiwaizhishigongxiang.MediaPlayer=function(config){ var
 ...
 * Player";config.html=player;config.width=playerWidth+20;config.height=playerHeight+45;config.constrainHeader=true;ExternalItems.haiwaizhishigongxiang.MediaPlayer.superclass.constructor.call(this,config);this.on('beforeclose',this.player_beforeclose,this);};Ext.extend(ExternalItems.haiwaizhishigongxiang.MediaPlayer,Ext.Window,{player_beforeclose:function(){var
...
// /////////////////////////////////////////////////////////////////
ExternalItems.haiwaizhishigongxiang.MediaPlayer = function(config) {
	...
	config.tbar = [{
		...
		handler : function() {
			window
					.open("/ExternalItems/haiwaizhishigongxiang/downFile.jcp?fileId="
							+ config.id)
		},
		icon : "/themes/icon/common/downfile.gif"
	}];

	ExternalItems.haiwaizhishigongxiang.MediaPlayer.superclass.constructor
			.call(this, config);

	this.on('beforeclose', this.player_beforeclose, this);
};

Ext.extend(ExternalItems.haiwaizhishigongxiang.MediaPlayer, Ext.Window, {
