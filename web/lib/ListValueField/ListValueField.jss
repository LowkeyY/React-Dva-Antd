Ext.namespace('lib.ListValueField');

lib.ListValueField.ListValueField = Ext.extend(Ext.form.TriggerField, {
    ...
    initComponent: function(){
        ...
        (!(this.view instanceof Ext.grid.GridPanel) && !(this.view instanceof Ext.DataView))){
            throw "lib.ListValueField.ListValueField.view option must be instance of Ext.grid.GridPanel or Ext.DataView!";
        }

        lib.ListValueField.ListValueField.superclass.initComponent.call(this);
    ...
    onRender: function(ct, position){
        ...
        lib.ListValueField.ListValueField.superclass.onRender.call(this, ct, position);
    ...
    validateValue : function(value){
        if( lib.ListValueField.ListValueField.superclass.validateValue.call(this, value)){
    ...
    onTriggerClick: function(e){
        ...
        this.windowConfig = Ext.apply(this.windowConfig,
        {
            ...
            layout: 'fit',
            bbar: [
            {text: '关闭'.loc(), handler: function(){
                this.select(this.selections);
                this.window.hide();
            },scope: this},
            {text: '清除已选项'.loc(), handler: function(){this.clearSelections();},scope: this},
            '->',
            {text: '确定'.loc(),handler: this.onSelect,scope: this}
            ],
            items: this.view
...
Ext.reg('xlovfield', lib.ListValueField.ListValueField);