...
bin.workflow.WorkflowAuthFramePanel= function(frames,params){
	...
	this.AuthPanel = new bin.workflow.WorkflowAuthPanel(this.frames,this.params.instanceId,this.params.parent_id);
	...
	var loader=new Ext.tree.TreeLoader({
			dataUrl:'/bin/workflow/roletree.jcp',
			requestMethod:"POST",
...
bin.workflow.WorkflowAuthFramePanel.prototype={
	init:function(instanceId){
		...
		this.frames.get("Workflow").mainPanel.setStatusValue(['流程权限管理'.loc()]);
	},
