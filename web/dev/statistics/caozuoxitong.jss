...
dev.statistics.caozuoxitong = function(tabWidth) {
	...
	Ext.Ajax.request({
		...
		success : function(response, options) {
			...
			this.chartSample.write('sample2');
