...
dev.integrate.InstanceAuthPanel = function(frames,instanceId,integrateId){
	this.frames=frames;
	this.instanceId=instanceId;
	this.integrateId=integrateId;
	this.ds=new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: '/dev/integrate/auth.jcp?',
			method : 'GET'
		}),
	...
	dev.integrate.InstanceAuthPanel.superclass.constructor.call(this,{
		region:'east',
		collapsible: false,
		split:true,
		width:400,
...
Ext.extend(dev.integrate.InstanceAuthPanel, Ext.Panel, {
	...
	save: function(params){
			...
			Ext.Ajax.request({ 
				url:'/dev/integrate/auth.jcp',
				params:{ids:ids,instanceId:this.instanceId,integrateId:this.integrateId},
				method: 'post',  
				scope:this,
