...
lib.ComboTree.MultiSelectTree = Ext.extend( Ext.form.ComboBox, {
	checkField		: 'checked',
	displayField	: "TEXT",
	valueField		: "VALUE",
	...
	constructor : function(){
		lib.ComboTree.MultiSelectComboTree.superclass.constructor.apply(this, arguments);
...
Ext.reg('MultiSelectTree', lib.ComboTree.MultiSelectTree );