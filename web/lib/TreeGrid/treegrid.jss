...
Ext.namespace('lib.TreeGrid.treegrid');
 ...
 * @abstract
 */
lib.TreeGrid.treegrid.AbstractTreeStore = Ext.extend(Ext.data.Store,
{
    /**
    ...
    {
        lib.TreeGrid.treegrid.AbstractTreeStore.superclass.constructor.call(this, config);
    ...
    remove : function(record)
    {
        ...
        // ----- End of modification        
        lib.TreeGrid.treegrid.AbstractTreeStore.superclass.remove.call(this, record);
    },
    ...
    load : function(options)
    {
        ...
        return lib.TreeGrid.treegrid.AbstractTreeStore.superclass.load.call(this, options); 
    },
   ...
   /**
    ...
    sort : function(fieldName, dir)
    {
        ...
        return lib.TreeGrid.treegrid.AbstractTreeStore.superclass.sort.call(this, fieldName, dir);         
    },    
 ...
 */
lib.TreeGrid.treegrid.AdjacencyListStore = Ext.extend(lib.TreeGrid.treegrid.AbstractTreeStore,
{
    /**
...
Ext.reg('lib.TreeGrid.treegrid.AdjacencyListStore', lib.TreeGrid.treegrid.AdjacencyListStore);

/**
 * Tree store for nested set tree representation.
 */
lib.TreeGrid.treegrid.NestedSetStore = Ext.extend(lib.TreeGrid.treegrid.AbstractTreeStore,
{
    /**
...
lib.TreeGrid.treegrid.GridView = Ext.extend(Ext.grid.GridView, 
{   
    ...
    initTemplates : function()
    {
        ...
        this.templates = ts;
        lib.TreeGrid.treegrid.GridView.superclass.initTemplates.call(this);
    },
    ...
    {
        lib.TreeGrid.treegrid.GridView.superclass.afterRender.call(this);
    ...
    ensureVisible : function(row, col, hscroll)
    {
        ...
        return lib.TreeGrid.treegrid.GridView.superclass.ensureVisible.call(this, row, col, hscroll);
    },
    ...
    {
        lib.TreeGrid.treegrid.GridView.superclass.initData.call(this, ds, cm);
        if (this.ds) {
    ...
    onLoad : function(store, records, options)
    {
        ...
        if (
            ...
            lib.TreeGrid.treegrid.GridView.superclass.onLoad.call(this, store, records, options);
        }
    },
    
    onAdd : function(ds, records, index)
    {
        lib.TreeGrid.treegrid.GridView.superclass.onAdd.call(this, ds, records, index);
        if (this.mainWrap) {
           //this.updateAllColumnWidths();
           this.processRows(0);
        }
    ...
    {
        lib.TreeGrid.treegrid.GridView.superclass.onRemove.call(this, ds, record, index, isUpdate);
        if(isUpdate !== true){
            if (this.mainWrap) {
                //this.updateAllColumnWidths();
                this.processRows(0);
    ...
    {
        lib.TreeGrid.treegrid.GridView.superclass.onUpdate.call(this, ds, record);
        if (this.mainWrap) {
            //this.updateAllColumnWidths();
            this.processRows(0);
        }
...
lib.TreeGrid.treegrid.GridPanel = Ext.extend(Ext.grid.GridPanel, 
{
    /**
    ...
    initComponent : function()
    {
        ...
        lib.TreeGrid.treegrid.GridPanel.superclass.initComponent.call(this);
    ...
    {
        lib.TreeGrid.treegrid.GridPanel.superclass.onRender.call(this, ct, position);
    ...
    {
        if (!this.view) {
            this.view = new lib.TreeGrid.treegrid.GridView(this.viewConfig);
        }
        return this.view;
    },
    ...
    onClick : function(e)
    {
        ...
        if (do_default) {
            lib.TreeGrid.treegrid.GridPanel.superclass.onClick.call(this, e);
        }
    },
    ...
    onMouseDown : function(e)
    {
        ...
        if (!Ext.fly(target).hasClass('ux-maximgb-tg-elbow-active')) {
            lib.TreeGrid.treegrid.GridPanel.superclass.onMouseDown.call(this, e);
        }
    },
...
lib.TreeGrid.treegrid.EditorGridPanel = Ext.extend(Ext.grid.EditorGridPanel, 
{
    /**
     * @cfg {String|Integer} master_column_id Master column id. Master column cells are nested.
     * Master column cell values are used to build breadcrumbs.
    ...
    initComponent : function()
    {
        ...
        lib.TreeGrid.treegrid.EditorGridPanel.superclass.initComponent.call(this);
    ...
    onRender : function(ct, position)
    {
        lib.TreeGrid.treegrid.EditorGridPanel.superclass.onRender.call(this, ct, position);
    ...
    onClick : function(e)
    {
        ...
        if (do_default) {
            lib.TreeGrid.treegrid.EditorGridPanel.superclass.onClick.call(this, e);
        }
    },
    ...
    onMouseDown : function(e)
    {
        ...
        if (!Ext.fly(target).hasClass('ux-maximgb-tg-elbow-active')) {
            lib.TreeGrid.treegrid.EditorGridPanel.superclass.onMouseDown.call(this, e);
        }
    },
 ...
 */
lib.TreeGrid.treegrid.PagingToolbar = Ext.extend(Ext.PagingToolbar,
{
    onRender : function(ct, position)
    {
        lib.TreeGrid.treegrid.PagingToolbar.superclass.onRender.call(this, ct, position);
        this.updateUI();
    },
    ...
    bindStore : function(store, initial)
    {
        ...
        lib.TreeGrid.treegrid.PagingToolbar.superclass.bindStore.call(this, store, initial);
    },
    ...
    beforeLoad : function(store, options)
    {
        ...
        lib.TreeGrid.treegrid.PagingToolbar.superclass.beforeLoad.call(this, store, options);
...
Ext.reg('lib.TreeGrid.treegrid.GridPanel', lib.TreeGrid.treegrid.GridPanel);
Ext.reg('lib.TreeGrid.treegrid.EditorGridPanel', lib.TreeGrid.treegrid.EditorGridPanel);
Ext.reg('lib.TreeGrid.treegrid.PagingToolbar', lib.TreeGrid.treegrid.PagingToolbar);
