 ...
 * @class lib.SuperSelect.SuperBoxSelect
 ...
 * 
 */
lib.SuperSelect.SuperBoxSelect = function(config) {
    lib.SuperSelect.SuperBoxSelect.superclass.constructor.call(this,config);
    this.addEvents(
        /**
         ...
         * @event beforeadditem
         * @memberOf lib.SuperSelect.SuperBoxSelect
 ...
 */
lib.SuperSelect.SuperBoxSelect = Ext.extend(lib.SuperSelect.SuperBoxSelect,Ext.form.ComboBox,{
    /**
    ...
    initComponent:function() {
       Ext.apply(this, {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.initComponent.call(this);
    ...
    onRender:function(ct, position) {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.onRender.call(this, ct, position);
        this.hiddenName = h;
    ...
    initEvents : function() {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.initEvents.call(this);
    ...
    onFocus: function() {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.onFocus.call(this);
    },
    ...
    onBlur: function() {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.onBlur.call(this);
    },
    ...
    onResize : function(w, h, rw, rh) {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.onResize.call(this, w, h, rw, rh);
        this.autoSize();
    },
    onEnable: function(){
        lib.SuperSelect.SuperBoxSelect.superclass.onEnable.call(this);
    ...
    onDisable: function(){
        lib.SuperSelect.SuperBoxSelect.superclass.onDisable.call(this);
        this.items.each(function(item){
            item.disable();
        });
        if(this.renderFieldBtns){
     ...
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name clearValue
    ...
    clearValue : function(supressRemoveEvent){
        lib.SuperSelect.SuperBoxSelect.superclass.clearValue.call(this);
    ...
    reset :  function(){
    	this.killItems();
        lib.SuperSelect.SuperBoxSelect.superclass.reset.call(this);
        this.addedRecords = [];
    ...
    /**
     * Adds an array of items to the SuperBoxSelect component if the {@link #lib.SuperSelect.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name addItem
     * @param {Array} newItemObjects An Array of object literals containing the property names and values for an item. The property names must match those specified in {@link #lib.SuperSelect.SuperBoxSelect-displayField}, {@link #lib.SuperSelect.SuperBoxSelect-valueField} and {@link #lib.SuperSelect.SuperBoxSelect-classField} 
     */
    ...
    /**
     * Adds a new non-existing item to the SuperBoxSelect component if the {@link #lib.SuperSelect.SuperBoxSelect-allowAddNewData} config is set to true.
     * This method should be used in place of addItem from within the newitem event handler.
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name addNewItem
     * @param {Object} newItemObject An object literal containing the property names and values for an item. The property names must match those specified in {@link #lib.SuperSelect.SuperBoxSelect-displayField}, {@link #lib.SuperSelect.SuperBoxSelect-valueField} and {@link #lib.SuperSelect.SuperBoxSelect-classField} 
     */
    addNewItem : function(newItemObject){
    	this.addItem(newItemObject,true);
    },
    /**
     * Adds an item to the SuperBoxSelect component if the {@link #lib.SuperSelect.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name addItem
     * @param {Object} newItemObject An object literal containing the property names and values for an item. The property names must match those specified in {@link #lib.SuperSelect.SuperBoxSelect-displayField}, {@link #lib.SuperSelect.SuperBoxSelect-valueField} and {@link #lib.SuperSelect.SuperBoxSelect-classField} 
     */
    ...
    addItemBox : function(itemVal,itemDisplay,itemCaption, itemClass, itemStyle) {
        ...
        var hConfig, parseStyle = function(s){
            ...
            return ret;
        }, itemKey = Ext.id(null,'sbx-item'), box = new lib.SuperSelect.SuperBoxSelectItem({
            owner: this,
    ...
    /**
     * Returns a String value containing a concatenated list of item values. The list is concatenated with the {@link #lib.SuperSelect.SuperBoxSelect-valueDelimiter}.
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name getValue
    ...
    /**
     * Returns an Array of item objects containing the {@link #lib.SuperSelect.SuperBoxSelect-displayField}, {@link #lib.SuperSelect.SuperBoxSelect-valueField}, {@link #lib.SuperSelect.SuperBoxSelect-classField} and {@link #lib.SuperSelect.SuperBoxSelect-styleField} properties.
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name getValueEx
    ...
    initValue : function(){
        if(Ext.isObject(this.value) || Ext.isArray(this.value)){
            ...
            lib.SuperSelect.SuperBoxSelect.superclass.initValue.call(this);
        }
        if(this.mode === 'remote') {
     ...
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name setValue
     * @param {String|Array} value An array of item values, or a String value containing a delimited list of item values. (The list should be delimited with the {@link #lib.SuperSelect.SuperBoxSelect-valueDelimiter) 
     */
    ...
    /**
     * Sets the value of the SuperBoxSelect component, adding new items that don't exist in the data store if the {@link #lib.SuperSelect.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf lib.SuperSelect.SuperBoxSelect
     * @name setValue
     * @param {Array} data An Array of item objects containing the {@link #lib.SuperSelect.SuperBoxSelect-displayField}, {@link #lib.SuperSelect.SuperBoxSelect-valueField} and {@link #lib.SuperSelect.SuperBoxSelect-classField} properties.  
     */
    ...
    onDestroy : function() {
        ...
        lib.SuperSelect.SuperBoxSelect.superclass.onDestroy.call(this);
    },
    autoSize : function(){
        if(!this.rendered){
            return this;
...
Ext.reg('superboxselect', lib.SuperSelect.SuperBoxSelect);
/*
 * @private
 */
lib.SuperSelect.SuperBoxSelectItem = function(config){
    Ext.apply(this,config);
    lib.SuperSelect.SuperBoxSelectItem.superclass.constructor.call(this); 
};
/*
 * @private
 */
lib.SuperSelect.SuperBoxSelectItem = Ext.extend(lib.SuperSelect.SuperBoxSelectItem,Ext.Component, {
    initComponent : function(){
        lib.SuperSelect.SuperBoxSelectItem.superclass.initComponent.call(this); 
    },
    ...
    onRender : function(ct, position){
        ...
        lib.SuperSelect.SuperBoxSelectItem.superclass.onRender.call(this, ct, position);
...
*/
    ...
    */
    ...
    onDisable : function() {
    	...
    	this.keyMap.disable();
    	lib.SuperSelect.SuperBoxSelectItem.superclass.onDisable.call(this);
    },
    onEnable : function() {
    	if(this.hidden){
    	...
    	this.keyMap.enable();
    	lib.SuperSelect.SuperBoxSelectItem.superclass.onEnable.call(this);
    },
    onDestroy : function() {
        Ext.destroy(
            //this.lnk,
        ...
        lib.SuperSelect.SuperBoxSelectItem.superclass.onDestroy.call(this);
    }
});