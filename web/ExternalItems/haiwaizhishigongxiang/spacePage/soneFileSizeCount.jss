...
ExternalItems.haiwaizhishigongxiang.spacePage.soneFileSizeCount = function() {
	this.id = "ExternalItems.haiwaizhishigongxiang.spacePage.soneFileSizeCount";
	this.init();
}
ExternalItems.haiwaizhishigongxiang.spacePage.soneFileSizeCount.prototype = {
	...
	refresh : function(){
		...
		var chart = this.chart , mainPanel = this.mainPanel , data = this.data;
			...
			if(!mainPanel.el || !mainPanel.el.dom)
				return;
			Ext.Ajax.request({
					url : '/ExternalItems/haiwaizhishigongxiang/spacePage/soneFileSizeCount.jcp',
					method : 'POST',
					scope : this,
